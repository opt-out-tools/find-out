...
def random_labelling(y_test):
    """Returns the proportion of samples that would be labelled
    correctly if totally random.

    Args:
        Series : The labels for the test data.

    Returns:
        float : The proportion that would correctly labelled if the
        process were totally random.
